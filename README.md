### LEARNING JPA RELATIONSHIPS

After finished backend part of udemy course (https://www.udemy.com/course/spring-boot-using-intellij-build-a-real-world-project) 
before moving forward with frontend part decided to split what I've learned into smaller blocks
